...
// Exported as a panel so it can be embedded in the unified /ai hub page.
// Still the default export so the legacy /ai-suite route keeps working.
export function AISuitePanel() {
  return (
    <div className="space-y-6">
      <p className="text-muted-foreground">
        Five AI workflows: dynamic pricing, waste-to-recipe, no-show prediction, tip fairness, SMS concierge.
      </p>
