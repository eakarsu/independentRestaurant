...
// Batch 10 page: "No gift cards" (nonai-gap) — independentRestaurant
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-gift-cards";
const LABEL = "No gift cards";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-gift-cards";

export default function NoGiftCardsPage() {
