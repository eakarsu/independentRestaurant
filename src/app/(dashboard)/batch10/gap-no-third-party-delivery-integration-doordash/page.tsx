...
// Batch 10 page: "No third-party delivery integration (DoorDash, Uber Eats)" (nonai-gap) — independentRestaurant
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-third-party-delivery-integration-doordash";
const LABEL = "No third-party delivery integration (DoorDash, Uber Eats)";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-third-party-delivery-integration-doordash";

export default function NoThirdPartyDeliveryIntegrationDoordashPage() {
