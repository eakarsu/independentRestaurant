...
// Batch 10 page: "Voice ordering (phone + drive-thru kiosk) routed to kitchen" (cfs) — independentRestaurant
'use client';
import { useEffect, useState } from 'react';

const SLUG = "voice-ordering-phone-drive-thru-kiosk";
const LABEL = "Voice ordering (phone + drive-thru kiosk) routed to kitchen";
const SECTION = "cfs";
const API_PATH = "/api/cf-voice-ordering-phone-drive-thru-kiosk";

export default function VoiceOrderingPhoneDriveThruKioskPage() {
