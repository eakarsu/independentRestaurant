...
// Batch 10 page: "No accounting export (QuickBooks / Xero)" (nonai-gap) — independentRestaurant
'use client';
import { useEffect, useState } from 'react';

const SLUG = "no-accounting-export-quickbooks-xero";
const LABEL = "No accounting export (QuickBooks / Xero)";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-accounting-export-quickbooks-xero";

export default function NoAccountingExportQuickbooksXeroPage() {
