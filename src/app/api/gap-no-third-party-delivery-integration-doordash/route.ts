...
// Batch 10 Gap: "No third-party delivery integration (DoorDash, Uber Eats)" (nonai-gap) for independentRestaurant
// Mount path: /api/gap-no-third-party-delivery-integration-doordash
